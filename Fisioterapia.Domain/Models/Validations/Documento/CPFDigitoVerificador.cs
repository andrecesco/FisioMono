...
namespace Fisioterapia.Domain.Models.Validations.Documento
{
    public class CPFDigitoVerificador
    {
        ...
        public CPFDigitoVerificador(string numero)
        {
            _numero = numero;
        }

        public CPFDigitoVerificador ComMultiplicadoresDeAte(int primeiroMultiplicador, int ultimoMultiplicador)
        {
        ...
        public CPFDigitoVerificador Substituindo(string substituto, params int[] digitos)
        {
